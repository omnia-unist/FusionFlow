...
# Decode -> (Changable) -> RandomCrop -> FlipAndNormalize
# Only Changable part is changable
OP_STAGE_ORDER = {
  "randaugment": {
    "Start": "Decode", 
...
# ptr = 0
# all_combs = list(combinations(RAND_AUGMENT_MANUAL_OPTIONS, N))
...
def next_op(stage_order, op_type):
  ...
  if nxt == "RandAugment_Manual":
    ...
    # ops = all_combs[ptr % len(all_combs)]
    # ptr += 1
