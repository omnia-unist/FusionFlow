...
import customUtils
import numpy as np
import NaiveGPUExecution as PinData
...
def main():
    ...
    if args.arch.startswith('vit'):
        file_name = f"DALINaive_worker_{args.workers}_Mem_Trace_vit_{args.augs}_b{args.batch_size}.csv"
    else:
        file_name = f"DALINaive_worker_{args.workers}_Mem_Trace_{args.arch}_{args.augs}_b{args.batch_size}.csv"
