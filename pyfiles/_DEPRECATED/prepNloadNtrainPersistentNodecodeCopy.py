...
def main_worker(gpu, ngpus_per_node, args):
    ...
    elif args.augs == "minnorandom":
        augmentations=[
                transforms.CenterCrop(size),
                transforms.ToTensor(),
            ]
    elif args.augs == "tensoronly":
        augmentations=[
                transforms.ToTensor()
            ]
    elif args.augs == "none":
...
customUtils.SharedImageFolder(
    #     traindir,
    #     augmentations_composed
    # )

    if __debug__:
        train_dataset = customUtils.FullTraceNoDecodeCopyedDistMemDataset(
            traindir,
            augmentations_composed
        )
    else:
        train_dataset = customUtils.NoDecodeCopyedDistMemDataset(
            traindir,
            augmentations_composed
        )
