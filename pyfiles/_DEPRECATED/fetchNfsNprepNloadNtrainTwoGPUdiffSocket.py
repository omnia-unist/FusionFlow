...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = customUtils.SharedImageFolder(
        traindir,
    ...
    # Divide with distributed
    if args.distributed:
        train_sampler = torch.utils.data.distributed.DistributedSampler(train_dataset)
    elif args.ddpmanual:
        train_sampler = torch.utils.data.distributed.DistributedSampler(dataset=train_dataset, num_replicas=4, rank=args.gpu)
    else:
        train_sampler = None
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    # sudoPassword = 'cs80207010'
    # command = './clearCaches.sh'
