...
import Augmix
import numpy as np
import localManagerGPUDirectAggr as PinData
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.distributed:
        ...
        if args.multiprocessing_distributed:
            ...
            gc.globalManager_init(workers, batch_size, args.threads, controllerClass=gc.globalManager, rank=args.rank)
    ...
    if args.seed is None:
        ...
        train_loader = PinData.DataLoader(
                train_dataset, batch_size=args.batch_size, shuffle=(train_sampler is None), rank = cur_rank,
                num_workers=args.workers, pin_memory=False, persistent_workers=True, sampler=train_sampler, drop_last=True, max_workers=CPU_NUM, aggr_shape_hint=template_shape, worker_init_fn=seed_worker, generator=g, worker_batch_size=args.threads, aug_type=args.augs)
