...
import Augmix
import numpy as np
import MicroBatchLoader as PinData
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.seed is None:
        ...
        train_loader = PinData.DataLoader(
                train_dataset, batch_size=args.batch_size, shuffle=(train_sampler is None), rank = cur_rank,
                num_workers=args.workers, pin_memory=False, persistent_workers=True, sampler=train_sampler, drop_last=True, worker_init_fn=seed_worker, generator=g, worker_batch_size=args.threads, aggr_shape_hint=(args.batch_size, 3, size, size))
