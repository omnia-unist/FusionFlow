...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.seed is None:
        ...
        train_loader = PinData.DataLoader(
                train_dataset, batch_size=args.batch_size, shuffle=(train_sampler is None), rank = cur_rank, single_sample=True,
        ...
        train_loader = PinData.DataLoader(
                train_dataset, batch_size=args.batch_size, shuffle=(train_sampler is None), rank = cur_rank, aug_type=args.augs, single_sample=True,
