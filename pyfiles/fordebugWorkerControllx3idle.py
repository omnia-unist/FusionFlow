    ...
    if args.distributed:
        ...
        if __debug__ and args.fulltrace:
            ...
            train_loader = PinData.DataLoader(
                ...
                num_workers=args.workers, pin_memory=False, shuffle=(train_sampler is None), sampler=train_sampler, batch_size=args.batch_size, persistent_workers=True, batch_sampler=batch_sampler, worker_batch_size=args.threads, drop_last=True, max_workers=args.workers*3)
        else:
            batch_sampler = None
            train_loader = PinData.DataLoader(
                train_dataset, rank = cur_rank,
        ...
        if args.ddpmanual:
            ...
            train_loader = PinData.DataLoader(
                ...
                num_workers=args.workers, pin_memory=False, persistent_workers=True, sampler=train_sampler, drop_last=True, worker_batch_size=args.threads, max_workers=args.workers*3)
