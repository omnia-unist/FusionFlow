...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # NOTE: hardcode calculating with system memory
    # Consider as 5x larger image size when decoding
    # OpenImage size: 517GB
    # 384GB / 5 / 517GB
    cache_ratio=0.14854932301
    
    if args.tracefetch:
        train_dataset = RefurbishImitate.RefurbishMimicDataset(
            traindir,
    ...
    if args.seed is None:
        ...
        train_loader = PinData.DataLoader(
                ...
                num_workers=args.workers, pin_memory=False, persistent_workers=True, sampler=train_sampler, drop_last=True, max_workers=CPU_NUM, aggr_shape_hint=template_shape, worker_init_fn=seed_worker, generator=g, worker_batch_size=args.threads)
