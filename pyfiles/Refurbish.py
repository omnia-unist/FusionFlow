...
# parser.add_argument('-c','--cache_ratio', default=0, type=float, metavar='N',
# help='Number of data loading worker threads')
parser.add_argument('-t','--threads', default=0, type=float, metavar='N',
help='Number of data loading worker threads')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    cache_ratio=float(args.threads)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            #}, is_best)
            pass
        shellscript = subprocess.Popen(["../scripts/clearCaches.sh"], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
