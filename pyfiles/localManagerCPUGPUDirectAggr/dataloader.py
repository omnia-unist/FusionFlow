...
class DataLoader(Generic[T_co]):
    ...
    def __init__(self, dataset: Dataset[T_co], batch_size: Optional[int] = 1,
        ...
        NUM_NODE = NODE_MAX+1
        GPU_PER_NODE = self.max_gpu // NUM_NODE
        self.dataloader_process = self.cpu_per_gpu * self.rank + self.num_workers
...
class _MultiProcessingDataLoaderIter(_BaseDataLoaderIter):
    ...
    def __init__(self, loader):
        ...
        self.dataloader_processes = loader.dataloader_processes
        ...
        self.gpu_worker_process = multiprocessing_context.Process(
                ...
                args=(self._gpu_index_queue, self._gpu_dali_queue, self._worker_result_queue, self._dataset, self._gpu_batch_size,
        ...
        self.worker_control_process = multiprocessing_context.Process(
                ...
                args=(self._rank, self._index_queues, self._task_queue, self._index_sampler, self._workers_control_events, self._intentional_stop_event, self._prefetch_factor, 
                      ...
                      self._microbatch_size, self._workers_status, self._world_size, self._gpu_index_queue, self._gpu_dali_queue, self._single_sample))
