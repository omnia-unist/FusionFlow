...
def _worker_loop(dataset_kind, dataset, index_queue, data_queue, done_event,
                 ...
                 num_workers, persistent_workers, rank, num_threads):
    ...
    try:
        ...
        try:
            ...
            fetcher = _DatasetKind.create_fetcher(dataset_kind, dataset, auto_collation, collate_fn, drop_last,rank,worker_id,num_threads)
        except Exception:
        ...
        while watchdog.is_alive():
            ...
            if isinstance(r, _ResumeIteration):
                ...
                fetcher = _DatasetKind.create_fetcher(
                    dataset_kind, dataset, auto_collation, collate_fn, drop_last,rank,worker_id,num_threads)
                continue
            elif r is None:
